...
from src.data.importers import NYUImporter, ICVLImporter
        ...
        if seqName not in self._imgStacks:
            ...
            for i in range(numImgs):
                if normZeroOne:
                    ...
                    # print(imgD.max()," ",imgD.min()," ",imgSeq.data[i].com[2])
                    pass
                    # img = Image.fromarray(imgD).convert('L')
                    # img.save('/home/penghao/PengHao/deep_prior/src/data/picture/{}.png'.format(i))
